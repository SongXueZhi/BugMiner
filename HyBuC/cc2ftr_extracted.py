...
from cc2ftr_utils import mini_batches


def extracted_cc2ftr(data, params):
    pad_added_code, pad_removed_code, labels, dict_msg, dict_code, bert_data = data
    ...
    with torch.no_grad():
        for i, (batch) in enumerate(tqdm(batches)):
            ...
            commit_ftr = model.forward_commit_embeds_diff(
