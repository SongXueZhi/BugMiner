...
from cc2ftr_extracted import extracted_cc2ftr
from cc2ftr_train import train_model
from codebert_data import convert_examples_to_features, TextDataset
from codebert_model import get_bertmodel, get_berttoken
...
def read_args():
    ...
    parser.add_argument('-project', type=str,
                        default='openstack', help='name of the dataset')

    # Training our model
    parser.add_argument('-train', action='store_true',
                        help='training attention model')

    parser.add_argument('-train_data', type=str, default='./data/pretrained/train.pkl',
                        help='the directory of our training data')
    parser.add_argument('-dictionary_data', type=str, default='./data/pretrained/dict.pkl',
                        help='the directory of our dicitonary data')

    # codebert
    parser.add_argument('-model_type', type=str, default='roberta',
                        help='the codebert model architecture to be fine-tuned')
    ...
    parser.add_argument('-predict_data', type=str,
                        help='the directory of our extracting data')
    parser.add_argument('-name', type=str, help='name of our output file')

    # Predicting our data
    parser.add_argument('-load_model', type=str,
                        default=None, help='loading our model')

    # Number of parameters for reformatting commits
    parser.add_argument('--msg_length', type=int, default=256,
    ...
    parser.add_argument('--code_line', type=int, default=10,
...
if __name__ == '__main__':
    ...
    if params.train is True:
        ...
        pad_msg_labels = convert_msg_to_label(
            pad_msg=pad_msg, dict_msg=dict_msg)

        tokenizer = get_berttoken(params)
        bert_data = TextDataset(
            added_code, pad_msg_labels, tokenizer, params)

        data = (pad_added_code, pad_removed_code,
                pad_msg_labels, dict_msg, dict_code, bert_data)
