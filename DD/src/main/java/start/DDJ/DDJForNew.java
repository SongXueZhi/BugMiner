...
public class DDJForNew {
    ...
    public void checkout(){
        ...
        SourceManager.createShellForNew(regression.getId(), message, projectName, bic, regression.getTestCaseString());
        SourceManager.createShellForNew(regression.getId(), message, projectName, work, regression.getTestCaseString());
        SourceManager.createShellForNew(regression.getId(), message, projectName, bfc, regression.getTestCaseString());
        SourceManager.createShellForNew(regression.getId(), message, projectName, buggy, regression.getTestCaseString());
    }
